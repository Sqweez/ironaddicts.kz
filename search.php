...
$products = $conn->query($sql);
?>
    <script type="text/javascript" src="js/search__helper.js" defer></script>
    <script>
        function getUrlVars() {
            var vars = {};
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                /* data.forEach(function (item, key, arr) {
                     ...
                     element.append('<div class="col-sm-4 col-xs-6"><div class="product clearfix product-hover"><div class="left"><div class="image "><a href="/product.php?id=' + item.product_id + '"><img src="http://iron.controlsoft.kz/' + item.product_img + '"alt="BSN Amino X 435 г" class="" style="max-height: 216px;"> </a> </div> </div> <div class="right"> <div class="name" style="height: 107px;"> <div class="label-discount green saleclear"> </div> <a href="/product.php?id='+ item.product_id +'">' + item.product_name + '<br>' + item.ves_kolvo_tabletok + '</a><div class="availability">Наличие: <span class="available">Есть в наличии</span></div></div> <div class="price">'+ item.prodazhnaya_cena + ' тенге</div> <div class="only-hover"> <a onclick="cart.add(&#39;108&#39;);class="button">Купить</a> <a onclick="cart.oneclick(&#39;108&#39;);" class="button">Купитьв 1 клик</a> <ul> <li><a onclick="wishlist.add(&#39;108&#39;);"class="btn-add-to-compare">добавить взакладки</a></li> <li><a onclick="compare.add(&#39;108&#39;);"class="btn-add-to-wishlist">Сравнить</a></li> </ul> </div> </div> </div></div>')
                     if((key+1)%3==0){
                         element.append('</div>');
                     }
                     let count = key;
            ...
            <div class="pattern">
                <div class="container">
                    <div class="clearfix">
                        ...
                        <span id="title-page">Результаты поиска</span>
                                                                    ...
                                                                    <div class="left">
                                                                        ...
                                                                        <div class="image ">
                                                                            ...
                                                                            <a href="https://kilosport.net/geynery/mutant-mass-2270-gr">
                                                                                ...
                                                                                <img src="category_img/mutant-mass--2-2kg-73x73.jpg"
                                                                    ...
                                                                    <div class="left">
                                                                        ...
                                                                        <div class="image ">
                                                                            ...
                                                                            <a href="https://kilosport.net/specialnye-preparaty/geneticlab-collagen-plus-225gr-45serv">
                                                                                ...
                                                                                <img src="category_img/510782bb966f4165de65f4d052a59a1-73x73.jpg"
                                                                            ...
                                                                            <ul>
                                                                                <li>
                                                                                    <a onclick="wishlist.add(&#39;676&#39;);"
                                                                                       class="btn-add-to-compare">добавить в
                                                                                        закладки</a></li>
                                                                                <li><a onclick="compare.add(&#39;676&#39;);"
                                                                    ...
                                                                    <div class="left">
                                                                        ...
                                                                        <div class="image ">
                                                                            ...
                                                                            <a href="https://kilosport.net/specialnye-preparaty/geneticlab-glycine-capsules">
                                                                                ...
                                                                                <img src="category_img/0a356aad9322cbd1aa99e48ba4aac859-73x73.jpg"
                                ...
                                <div class="col-md-12 center-column" id="content">
                                    ...
                                    <div id="mfilter-content-container">
                                            ...
                                            <div class="options">
                                                ...
                                                <div class="button-group display" data-toggle="buttons-radio">
                                                    ...
                                                    <button id="list" rel="tooltip" title="List"
                                                            onclick="display(&#39;list&#39;);"><i class="fa fa-th-list"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="list-options">
                                                <div class="sort">
                                                    Сортировка: <select onchange="location = this.value">
                                                        <option value="/category.php?id=<?=$id?>&page=<?=$page?>">По умолчанию
                                                        </option>
                                        ...
                                        <div class="row pagination-results">
                                            ...
                                            <div class="col-sm-5 text-right">Показано с <?=$limitStart+1?> по <?=ceil(($countTotal)/(($countOfPages-$page)+1))?> из <?=$countTotal;?> (всего <?=$countOfPages;?> страниц)</div>
                                        </div>
